  ...
  return (
    <I18nextProvider i18n={i18n}>
      <QueryClientProvider client={queryClient}>
        ...
        <Toaster position="bottom-center" offset={{ bottom: "calc(env(safe-area-inset-bottom) + 130px)" }} mobileOffset={{ bottom: "calc(env(safe-area-inset-bottom) + 130px)" }} closeButton={false} />
      </QueryClientProvider>
    </I18nextProvider>
  );
}
